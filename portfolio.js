...
export default function Portfolio() {
  ...
  "languages": ["Python", "JavaScript", "SQL", "Dart"]
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "1.5rem" }}>
              <GlassCard style={{ padding: "1.5rem" }}>
                ...
                <div style={{ marginBottom: "1.5rem" }}>
                  ...
                  <div style={{ display: "flex", gap: "1fr", flexWrap: "wrap", gap: "1rem" }}>
      ...
      <section id="skills" style={{ padding: "4rem 1.5rem", maxWidth: "1000px", margin: "0 auto" }}>
        <FadeIn><SectionTitle>// 04. Compétences & Vision d'Évolution</SectionTitle></SectionTitle>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1.5rem" }}>
          ...
          <GlassCard style={{ padding: "1.25rem" }}>
            ...
            <p style={{ color: COLORS.textSecondary, fontSize: "0.82rem", lineHeight: 1.6 }}>
              <strong>Acquis :</strong> Force d'analyse pour traquer les contraintes aberrantes cachées (comme le bug des 3 points min sur Voronoï) et optimiser les flux de requêtes SQL locaux pour préserver le matériel.
            </p>
            <p style={{ color: COLORS.mono, fontSize: "0.78rem", margin: "8px 0 0" }}>
